...
class SoftClusterTrainer(VRPTWLLMTrainer):
    ...
    def __init__(self, env_p, model_p, opt_p, trainer_p, llm_p):
        ...
        # BKS few-shot block: precomputed once, prepended to init LLM calls that have no episode experience
        ...
        if llm_p.get('enabled', True) and not llm_p.get('no_init_llm', False):
            ...
            try:
                ...
                print(f'[BKS fewshot] Failed to build ({_e}); continuing without.')
