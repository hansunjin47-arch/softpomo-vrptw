"""
Phase 1 (base-only) checkpoint eval on all test scenarios.
C1: c101 + rain_A/B + acc_A/B
RC1: rc101 + rain_A/B + acc_A/B
R1:  r101  + rain_A/B + acc_A/B
"""
...
JOBS = [
    dict(
        benchmark='c1',
        ckpt=os.path.join(_RES, 'config_F_pomo100', 'c102-c109', 'checkpoint-last.pt'),
        tag='p1_eval',
        log='eval_p1_c1.log',
    ),
    dict(
        benchmark='rc1',
        ckpt=os.path.join(_RES, 'config_F_rc1_pomo100', 'rc102-rc108', 'checkpoint-last.pt'),
        tag='p1_eval',
        log='eval_p1_rc1.log',
    ),
    dict(
        benchmark='r1',
        ckpt=os.path.join(_RES, 'config_F_r1_pomo100', 'r102-r112', 'checkpoint-last.pt'),
        tag='p1_eval',
        log='eval_p1_r1.log',
    ),
]
