"""run_proposed_rc_r_queue.py — SoftPOMO (with LLM) Config F: RC1 -> R1."""
...
LOG_FILE = os.path.join(SOFT, 'logs', 'proposed_rc_r_queue.log')
...
log('=== proposed_rc_r_queue started ===')
